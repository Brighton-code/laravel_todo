<x-app-layout>
                        ...
                        <div class="flex justify-between">
                            <div class="flex items-center">
                                <a href="{{ route('todos.index', $category) }}">
                                    ...
                                    <label for="todo1"
                                           class="ml-3 block text-gray-900 dark:text-gray-100 cursor-pointer">
                            ...
                            <div class="ml-auto flex items-center">
                                <a class="h-full"
                                   ...
                                   onclick="showModal(this, {{ $category->id }})">
    ...
    <button id="popup-button" class="hidden" onclick="document.getElementById('popup-modal').classList.remove('hidden')"
